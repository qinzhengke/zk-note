...
<hr>
\section cpp_debug_release debug和release的不要混用！
...
<hr>
\section 非4整数倍尺寸图像存成bmp文件出错？
bmp标准强行要求图像宽度4字节对齐，所以一定要非4整数倍宽度一定要补齐。

<hr>
\section 多线程启动函数注意局部变量的使用

...
\section pthread_dso_missing libpthread.so.0: error adding symbols: DSO missing from command line
...
\section thread_not_member_boost error 'thread' is not a member of 'boost'

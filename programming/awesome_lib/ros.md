...
\subsection QtCreator+cmake工程+ROS
...
3.QtCreator中的projects页面，build directory写成catkin_ws/build，否则QtCreator无法解析package工程。\subsection 

\subsection 系统设置与工作目录设置冲突？
...
\subsection Clock skew detected. Your build may be incomplete.
\code{bash}
caktin_make clean
catkin_make
\endcode
...
\subsection ros_issue_launch ros launch额外传参

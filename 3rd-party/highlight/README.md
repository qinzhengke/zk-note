...
[![license](https://badgen.net/github/license/highlightjs/highlight.js?color=cyan)](https://github.com/highlightjs/highlight.js/blob/test/LICENSE)
...
Please read [VERSION_10_UPGRADE.md](https://github.com/highlightjs/highlight.js/blob/test/VERSION_10_UPGRADE.md) for  high-level summary of breaking changes and any actions you may need to take. See [VERSION_10_BREAKING_CHANGES.md](https://github.com/highlightjs/highlight.js/blob/test/VERSION_10_BREAKING_CHANGES.md) for a more detailed list and [CHANGES.md](https://github.com/highlightjs/highlight.js/blob/test/CHANGES.md) to learn what else is new.

##### Support for older versions

Please see [SECURITY.md](https://github.com/highlightjs/highlight.js/blob/test/SECURITY.md) for support information.
...
see [DIGESTS.md](https://github.com/highlightjs/cdn-release/blob/test/DIGESTS.md).
...
[7]: https://github.com/highlightjs/highlight.js/blob/test/LICENSE
[8]: https://github.com/highlightjs/highlight.js/blob/test/CONTRIBUTORS.md
[9]: https://github.com/highlightjs/highlight.js/blob/test/SUPPORTED_LANGUAGES.md
